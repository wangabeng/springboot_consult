        ...
        <form>
          ...
          <div class="form-group">
            <label for="exampleInputFile" class='row'>
              ...
              <p class='col-sm-10'>上传主图</p>
            </label>
            <input type="file" class="form-control-file col-sm-10" style='display: none' id="exampleInputFile" @change="uploadFile($event)"/>
          </div>
...
export default {
  ...
  methods: {
    ...
    editorSubmit () {
      ...
      var _this = this;
      // 可选地，上面的请求可以这样做
      axios.get(BASEURL + '/article/editorsubmit', {
          params: {
